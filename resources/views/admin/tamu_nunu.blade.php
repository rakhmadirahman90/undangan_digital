...
<div class="max-w-4xl mx-auto px-5 py-10">
    ...
    <div class="bg-white rounded-2xl shadow p-6 mb-8">
        ...
        <form action="{{ route('tamu.nunu.store') }}"
              method="POST">
 ...
 @forelse($tamu as $item)
    ...
    @php
        $linkUndangan = route('undangan.nunu') . '?to=' . urlencode($item->name);
    @endphp

    <div class="px-6 py-5 border-b last:border-b-0 flex flex-col gap-4">
        ...
        <div class="flex gap-2 flex-wrap">
            ...
            <form
                action="{{ route('tamu.nunu.destroy', $item) }}"
                method="POST"
