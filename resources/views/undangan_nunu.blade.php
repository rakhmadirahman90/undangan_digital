...
<head>
    ...
    <title>Undangan Pernikahan Digital - Nunu & Hadis</title>
    <!-- Tailwind CSS -->
...
<div id="coverOverlay"
 ...
 <!-- Maps Location Action -->
            <div class="mt-8 text-center reveal-on-scroll">
                <a href="https://maps.app.goo.gl/kSyhJ7GAJzgV3D9x8" target="_blank" class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-amber-400 via-brandGold to-amber-600 text-brandRed-dark font-bold text-xs tracking-wider uppercase shadow-xl hover:scale-105 active:scale-95 transition">
...
<section id="gallery" class="py-16 px-5 bg-cream">
    ...
    <div class="text-center mb-10 reveal-on-scroll">
        ...
        <p class="text-xs text-slate-600">
            Dokumentasi kebersamaan Nunu & Hadis
        </p>
    </div>
...
<section id="rsvp" class="py-16 px-5 bg-cream">
    ...
    <div class="text-center mb-10 reveal-on-scroll">
        ...
        <p class="text-xs text-slate-600 max-w-xs mx-auto leading-relaxed">
            ...
            Mohon konfirmasi kehadiran dan berikan
    ...
    <div class="mt-10 reveal-on-scroll">
        ...
        <div
            ...
            @forelse($ucapan as $item)
                ...
                <div class="ucapan-item glass-card p-4 rounded-2xl
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @elseif($item->attendance === 'Tidak Hadir')
...
function startCountdown() {
    ...
    const targetDate = new Date('September 5, 2026 00:00:00 GMT+0800').getTime();
  ...
  async function submitRSVP(event) {
    ...
    const attendance =
        document.getElementById('attendanceInput')
        .value;

    const personCount =
        document.getElementById('personCountInput')
        .value;
        ...
        */
        ...
        newUcapan.innerHTML = `
            ...
            <div class="flex items-center justify-between">
                ...
                <strong
                    class="text-brandRed-900 font-semibold">

                    ${escapeHTML(ucapan.name)}
